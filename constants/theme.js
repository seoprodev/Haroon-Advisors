...
export const lawyerprefix = "lawyer/";
export const COLORS = {
  primary: '#81D8D0',
  primary2: '#14b987',
  primary3: '#337bff',
...
export const FONTS = {
  fontPoppins: { fontFamily: 'ElMessiri-Regular' },
  fontNunito: { fontFamily: 'ElMessiri-Regular' },
  fontArabic: { fontFamily: 'ElMessiri-Regular' },
  fontLg: {
  ...
  h1: { fontSize: SIZES.h1, color: COLORS.title, fontFamily: 'ElMessiri-Regular' },
  h2: { fontSize: SIZES.h2, color: COLORS.title, fontFamily: 'ElMessiri-Regular' },
  h3: { fontSize: SIZES.h3, color: COLORS.title, fontFamily: 'ElMessiri-Regular' },
  h4: { fontSize: SIZES.h4, color: COLORS.title, fontFamily: 'ElMessiri-Regular' },
  h5: { fontSize: SIZES.h5, color: COLORS.title, fontFamily: 'ElMessiri-Regular' },
  h6: { fontSize: SIZES.h6, color: COLORS.title, fontFamily: 'ElMessiri-Regular' },
  fontBold: { fontFamily: 'ElMessiri-Regular' },
};
export const ICONS = {
  ...
  share: `<svg width="15" height="14" viewBox="0 0 15 14" xmlns="http://www.w3.org/2000/svg"><path d="M14.7566 4.93237L9.60021 0.182841C9.14886 -0.23294 8.4375 0.104591 8.4375 0.750465V3.25212C3.73157 3.30959 0 4.31562 0 9.07267C0 10.9927 1.1596 12.8948 2.4414 13.8893C2.84139 14.1996 3.41145 13.8101 3.26397 13.3071C1.93553 8.77542 3.89405 7.57236 8.4375 7.50264V10.25C8.4375 10.8969 9.14942 11.2329 9.60021 10.8176L14.7566 6.06761C15.0809 5.7688 15.0814 5.23158 14.7566 4.93237Z"/></svg>`,
  ...
  grid: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 3H3V10H10V3Z" stroke="#81D8D0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M21 3H14V10H21V3Z" stroke="#81D8D0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M21 14H14V21H21V14Z" stroke="#81D8D0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M10 14H3V21H10V14Z" stroke="#81D8D0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  list: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 6H21" stroke="#81D8D0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 12H21" stroke="#81D8D0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 18H21" stroke="#81D8D0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M3 6H3.01" stroke="#81D8D0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M3 12H3.01" stroke="#81D8D0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M3 18H3.01" stroke="#81D8D0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  ...
  infodrawer: `<svg xmlns="http://www.w3.org/2000/svg" height="22" viewBox="0 -4 512.001 512" width="22" fill="#bfc9da" xmlns:v="https://vecta.io/nano"><path d="M255.836 503c-13.789 0-26.562-6.223-35.062-17.09l-51.141-64.855L79.988 421C35.887 421 0 385.113 0 341V80C0 35.887 35.887 0 80 0h352c44.113 0 80 35.887 80 80v161c0 11.047-8.953 20-20 20s-20-8.953-20-20V80c0-22.055-17.945-40-40-40H80c-22.055 0-40 17.945-40 40v261c0 22.055 17.945 40 40 40l99.352.059a20 20 0 0 1 15.691 7.617l57.191 72.527c1.168 1.496 2.594 1.797 3.605 1.797h.02a4.38 4.38 0 0 0 3.563-1.762l.105-.137 56.727-72.434c3.793-4.84 9.598-7.668 15.746-7.668h100c22.059 0 40-17.945 40-40 0-11.047 8.953-20 20-20s20 8.953 20 20c0 44.113-35.887 80-80 80h-90.258l-50.68 64.707c-8.453 10.938-21.219 17.238-35.047 17.293h-.18zM276 305V197c0-11.047-8.953-20-20-20s-20 8.953-20 20v108c0 11.047 8.953 20 20 20s20-8.953 20-20zm-20-197c-11.047 0-20 8.953-20 20s8.953 20 20 20 20-8.953 20-20-8.953-20-20-20zm0 0"/></svg>`,
  ...
  messagesdrawer: `<svg id="Capa_1" enable-background="new 0 0 512 512" fill="#bfc9da" height="22" viewBox="0 0 512 512" width="22" xmlns="http://www.w3.org/2000/svg"><g><path d="m354.03 31.622h-296.13c-31.93 0-57.9 25.97-57.9 57.9v259.5c0 12.29 13.899 19.218 23.71 12.21l82.47-58.84c6.92-4.93 15.06-7.54 23.56-7.54h181.39c31.93 0 57.9-25.97 57.9-57.9v-190.33c0-8.28-6.72-15-15-15zm-72.86 181.71h-173.31c-8.28 0-15-6.71-15-15 0-8.28 6.72-15 15-15h173.31c8.28 0 15 6.72 15 15 0 8.29-6.72 15-15 15zm0-70h-173.31c-8.28 0-15-6.71-15-15 0-8.28 6.72-15 15-15h173.31c8.28 0 15 6.72 15 15 0 8.29-6.72 15-15 15z"/><path d="m512 205.872v259.49c0 12.207-13.829 19.268-23.71 12.21l-82.47-58.83c-6.92-4.93-15.06-7.54-23.56-7.54h-181.39c-31.93 0-57.9-25.98-57.9-57.91v-28.44h168.16c48.47 0 87.9-39.43 87.9-87.9v-88.99h55.07c31.93 0 57.9 25.98 57.9 57.91z"/></g></svg>`,
...
export const IMAGES = {
  googleIcon: require('../assets/images/global/google.png'),
  paymentGateways: require('../assets/images/global/payment-icons.png'),
  appLogo: require('../assets/images/global/light-logo.png'),
  darkappLogo: require('../assets/images/global/dark-logo.png'),
  lighterappLogo: require('../assets/images/global/lighter-logo.png'),
  darkerappLogo: require('../assets/images/global/darker-logo.png'),
  appIcon: require('../assets/images/global/light-icon.png'),
  darkappIcon: require('../assets/images/global/dark-icon.png'),
  ...
  //global icons end
  admindep: require('../assets/images/global/post/administrative-department.jpg'),
  civildep: require('../assets/images/global/post/civil-department.jpg'),
  commercialdep: require('../assets/images/global/post/commercial-department.jpg'),
  constructiondep: require('../assets/images/global/post/construction-department.jpg'),
  criminaldep: require('../assets/images/global/post/criminal-department.jpg'),
  labordep: require('../assets/images/global/post/labor-department.jpg'),
  personaldep: require('../assets/images/global/post/personal-department.jpg'),
  realdep: require('../assets/images/global/post/real-department.jpg'),
  residencydep: require('../assets/images/global/post/residency-department.jpg'),
  sportsdep: require('../assets/images/global/post/sports-department.jpg'),
  //flags
  UnitedArabEmirates: require('../assets/images/global/flags/UnitedArabEmirates.png'),
  Pakistan: require('../assets/images/global/flags/pakistan.png'),
